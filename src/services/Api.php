...
class Api extends Base
{
    ...
    public function track(string $event, array $profile, ?EventProperties $eventProperties = null, ?string $timestamp = null): void
    {
        ...
        $mappedProperties = $eventProperties === null ? [] : $eventProperties->toArray();
    ...
    public function getLists()
    {
        if ($this->cachedLists === null) {
            ...
            do {
                $result = $this->api->Lists->getLists(['name'], null, null, null, $cursor);
                $lists = [
                    ...$lists,
                    ...$result['data'],
                ];
    ...
    {
        $result = $this->api->Profiles->getProfiles(null, null, "equals(email,\"{$profileEmail}\")");
